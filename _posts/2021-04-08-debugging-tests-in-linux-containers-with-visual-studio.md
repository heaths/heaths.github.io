...
tags:
  - debugging
  - visualstudio
atUri: "at://did:plc:tg3tb5wukiml4xmxml6qm637/site.standard.document/3mfdr2b3oe62t"
---
...
1. You'll build a container image using that _Dockerfile_. In the directory where you saved the _Dockerfile_, run:
